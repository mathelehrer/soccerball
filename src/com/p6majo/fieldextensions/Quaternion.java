...
public class Quaternion {
    ...
    public Quaternion(double real, Vector vector){
    ...
    /**
     * Of the quaternion q=(a,b,c,d) the vector part is returned, i.e. new Vector(b,c,d);
     * @return
     */
    public Vector getVector(){
        return new Vector(this.a.im(),this.b.re(),this.b.im());
    }
    ...
    public Vector getEulerAnglesDegrees(){
