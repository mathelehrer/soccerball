...
import com.p6majo.soccerball.SimulationView;
...
//                media =  new Media(url.toString());
    ...
    public void generateAnimation(){
        com.p6majo.povrayanimation.VideoGenerationThread thread =new com.p6majo.povrayanimation.VideoGenerationThread(PATH,TMPPATH,name,fps,maxdigits);
        thread.start();
        try {
            thread.join();
